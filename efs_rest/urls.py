...
urlpatterns = [
    ...
    url(r'^api/customerstocks/(?P<pk>[0-9]+)$', views.CustomerStocks),
    url(r'^api/customerinvestments/(?P<pk>[0-9]+)$', views.CustomerInvestments),
    ...
    url(r'^api/mutualfunds/$', views.mutualfund_list),
    url(r'^api/mutualfunds/(?P<pk>[0-9]+)$', views.getMutualFund),
]
